...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Álex Ferreira", 31, "alex.clayton@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Thais Stephany", 34, "thais@gmail.com", conta02.getId(), true);
